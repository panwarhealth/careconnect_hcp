...
if ( ! class_exists( 'Use_Child_Theme' ) && is_admin() ) {
    ...
    class Use_Child_Theme
    {
        ...
        function admin_init() {
            ...
            // Exit if no direct access // commented for shared hosting
...
?>
        ...
        <div class="notice notice-error uct-notice is-dismissible">
            <p>
                <?php printf( esc_html__( 'Please use a %s child theme to make changes', 'wp-spinnr' ), $this->theme->get( 'Name' ) ); ?>
                <a class="uct-activate" href="javascript:;"><?php esc_html_e( 'Activate now', 'wp-spinnr' ); ?></a>
            </p>
        </div>
<?php
        }
        ...
        function activate_child_theme() {
            ...
            wp_die( esc_html__( 'All done!', 'wp-spinnr' ) );
        }
