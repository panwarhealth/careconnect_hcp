...
switch(TBST_SPINNR_FRAMEWORK){
	case 'tailwind-2':
		$classes = array(
            ...
            'class1' => 'ml-auto lg:hidden',
            'class2' => 'ml-auto hidden lg:block',
            'class3' => 'flex flex-col justify-between',
            'class4' => 'block xl:inline text-muted mb-1 xl:mb-0 mr-3',
            'small' => 'text-sm',
	...
	default:
		$classes = array(
            'navbar' => 'navbar navbar-expand-lg',
            'class1' => 'ml-auto d-lg-none',
            'class2' => 'ml-auto d-none d-lg-block',
            'class3' => 'd-flex flex-column justify-content-between',
            'class4' => 'd-block d-xl-inline text-muted mb-1 mb-xl-0 mr-2',
            'small' => 'small',
...
<div class="<?php echo $classes['navbar']; ?>">
    ...
    ?>
    <div class="<?php echo $classes['class1']; ?>"><?php dynamic_sidebar('header-section-mobile'); ?></div>
    <div class="<?php echo $classes['class2']; ?>"><?php dynamic_sidebar('header-section'); ?></div>
</div>
<div class="navbar-side" id="menu-sidebar">
    <div class="navbar-side-content <?php echo $classes['class3']; ?> <?php echo get_theme_mod('header_class', 'bg-light');?>">
