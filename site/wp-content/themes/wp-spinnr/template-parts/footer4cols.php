...
switch(TBST_SPINNR_FRAMEWORK){
	case 'tailwind-2':
		$classes = array(
			...
			'col1' => 'w-full lg:w-1/4',
			'col2' => 'w-full lg:w-1/4',
            'col3' => 'w-full lg:w-1/4',
            'col4' => 'w-full lg:w-1/4',
		);
		break;
	default:
		$classes = array(
			...
			'row2' => get_theme_mod('footer_link_class', 'text-dark'),
			'col1' => 'col-12 col-lg-3',
			'col2' => 'col-12 col-lg-3',
            'col3' => 'col-12 col-lg-3',
            'col4' => 'col-12 col-lg-3',
		);
		break;
}
?>
