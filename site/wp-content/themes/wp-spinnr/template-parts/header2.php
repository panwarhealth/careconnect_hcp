...
switch(TBST_SPINNR_FRAMEWORK){
	case 'tailwind-2':
		$classes = array(
            ...
            'class1' => 'w-3/12 lg:hidden px-0',
            'class2' => 'w-5/12 collapse navbar-collapse font-medium px-0',
            'class3' => 'w-3/12 lg:hidden text-right px-0',
            'class4' => 'w-5/12 hidden lg:block text-right px-0',
            'class5' => 'flex flew-wrap flex-col justify-between',
            'class6' => 'block xl:inline text-muted mb-1 xl:mb-0 mr-3',
            'small' => 'text-sm',
	...
	default:
		$classes = array(
            ...
            'class1' => 'col-3 d-lg-none px-0',
            'class2' => 'col-5 collapse navbar-collapse weight-500 px-0',
            'class3' => 'col-3 d-lg-none text-right px-0',
            'class4' => 'col-5 d-none d-lg-block text-right px-0',
            'class5' => 'd-flex flex-column justify-content-between',
            'class6' => 'd-block d-xl-inline text-muted mb-1 mb-xl-0 mr-2',
            'small' => 'small',
...
<div class="<?php echo $classes['navbar']; ?>">
    ...
    wp_nav_menu(array(
        ...
        'container_class' => $classes['class2'],
    ...
    <div class="<?php echo $classes['class3']; ?>"><?php dynamic_sidebar('header-section-mobile'); ?></div>
    <div class="<?php echo $classes['class4']; ?>"><?php dynamic_sidebar('header-section'); ?></div>
</div>
<div class="navbar-side" id="menu-sidebar">
    <div class="navbar-side-content <?php echo $classes['class5']; ?> <?php echo get_theme_mod('header_class', 'bg-light');?>">
