...
<div class="woocommerce-variation-add-to-cart variations_button">
	...
	<div class="flex items-center space-x-base mb-2xl">
		<?php
		...
		<button type="submit" class="single_add_to_cart_button btn cta m-0 alt<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>">
